...
var dbInstance = new database.Database(options);
var server;
var userInstance;
var gamesInstance;
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                server.members.forEach(function (member) { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, userInstance.createNewUser(member.user, false)];
                            case 1:
                                _a.sent();
                                return [4 /*yield*/, userInstance.getUserPairs(member.user.id)];
                            case 2:
                                _a.sent();
                                return [2 /*return*/];
                        }
                ...
                return [4 /*yield*/, generatePairsForEachUser()];
            case 2:
                _a.sent();
                return [2 /*return*/];
        }
...
client.on('guildMemberAdd', function (member) { return __awaiter(_this, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, userInstance.createNewUser(member.user, true)];
            case 1:
                _a.sent();
                return [4 /*yield*/, userInstance.getUserPairs(member.user.id)];
            case 2:
...
function generatePairsForEachUser() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, dbInstance.getUsers()];
                case 1:
                    users = _a.sent();
                    users.forEach(function (user) { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, userInstance.getUserPairs(user.Uuid)];
                                case 1:
                                    _a.sent();
                                    return [2 /*return*/];
                            }
